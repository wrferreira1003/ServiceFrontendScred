              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg
                ...
                <div className="mt-5 sm:mt-6 flex gap-2">
                  ...
                  <button 
                    ...
                    className="inline-flex w-full justify-center rounded-md bg-orange-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:orange-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-800"
                  >
                    Baixar Excel
                  </button>
                </div>
