...
const projects = [
  {
    ...
    href: "#",
    descricao:
      "garantimos a segurança e autenticidade dos seus documentos jurídicos. Nossa gama de serviços inclui a preparação de escrituras públicas, procurações, testamentos e atas notariais, além do reconhecimento de firmas e autenticações de cópias de documentos. ",
  },
  {
    id: 2,
    name: "Cartório de Tabelionato",
...
export default function Body() {
  return (
    <div className="mx-auto w-4/5">
      <h1 className="mb-7 mt-5 text-3xl text-gray-900">
      ...
      <ul role="list" className="w-full rounded-2xl">
        {projects.map((project) => (
          <li
            key={project.id}
            className="my-4 flex items-center justify-between gap-x-6 rounded-lg border bg-slate-100 px-4 py-5"
          >
