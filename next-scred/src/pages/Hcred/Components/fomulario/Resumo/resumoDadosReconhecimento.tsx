...
export default function ResumoDadosReconhecimento({InfoPessoal, Documentos, Endereco}:any){
  return (
    <div className="w-full">
      ...
      <div className="mt-6">
        <dl className="grid sm:grid-cols-6">
          ...
          <div className="border-t border-gray-100 px-4 sm:col-span-1 sm:px-0">
            <dt className="text-sm font-roboto font-bold leading-6 text-gray-900">Estado Civil:</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-1">{InfoPessoal?.estadocivil}</dd>
          </div>
          <div className="border-t border-gray-100 px-4 sm:col-span-1 sm:px-0">
            <dt className="text-sm font-roboto font-bold leading-6 text-gray-900">Profissão:</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-1">{InfoPessoal?.profissao}</dd>
          </div>
          <div className="border-t border-gray-100 px-4 sm:col-span-1 sm:px-0">
            <dt className="text-sm font-roboto font-bold leading-6 text-gray-900">Data de Nascimento:</dt>
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-1">{InfoPessoal?.nascimento.toLocaleDateString()}</dd>
          </div>
          <div className="border-t border-gray-100 px-4 sm:col-span-1 sm:px-0">
